...
const PORTFOLIO_CONTENT = {
  ...
  achievements: [
    ...
    },
    {
      ...
      description: "Google Play Academy (Jun 2025, valid through Jun 2028) — Certified in Google Play Store listing best practices.",
      type: "certification",
    },
    {
      icon: "smartphone",
      title: "Android Jetpack Compose: The Comprehensive Bootcamp",
      description: "Udemy, Nov 2025 (37 hrs) — Comprehensive bootcamp covering Jetpack Compose from fundamentals to advanced topics.",
      type: "certification",
    },
    {
      icon: "layers",
      title: "Modern Android App Architecture",
      description: "Udemy, Jun 2026 (9.5 hrs) — Modern architecture patterns and best practices for Android development.",
      type: "certification",
    },
    {
      icon: "zap",
      title: "Gradle Build Caching",
      description: "DPE University (Gradle), Mar 2025 — Certified in Gradle build caching strategies for optimizing build performance.",
      type: "certification",
    },
  ],
